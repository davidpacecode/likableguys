...
<sl-tab-group>
  ...
  <sl-tab slot="nav" panel="motivational_time_browser">Motivational Time Browser</sl-tab>
  ...
  <sl-tab-panel name="motivational_time_browser">

    <form class="input-validation-required" action="/motivational_time_browser" method="get">
