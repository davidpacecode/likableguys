...
class SwimMeetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create swim_meet" do
    assert_difference("SwimMeet.count") do
      post swim_meets_url, params: { swim_meet: { address: @swim_meet.address, description: @swim_meet.description, end_date: @swim_meet.end_date, location: @swim_meet.location, name: @swim_meet.name, start_date: @swim_meet.start_date, url: @swim_meet.url } }
    end
  ...
  test "should update swim_meet" do
    patch swim_meet_url(@swim_meet), params: { swim_meet: { address: @swim_meet.address, description: @swim_meet.description, end_date: @swim_meet.end_date, location: @swim_meet.location, name: @swim_meet.name, start_date: @swim_meet.start_date, url: @swim_meet.url } }
